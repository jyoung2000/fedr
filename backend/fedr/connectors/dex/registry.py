...
DEXES: dict[str, DexSpec] = {
    ...
    for d in [
        DexSpec(
            ...
            None,
            200_000,
            testnet_network="devnet",
            notes="aggregator; fee embedded in route output; Jupiter API key recommended (lite API deprecated)",
        ),
        DexSpec(
            "raydium",
            "raydium",
            ...
            200_000,
            testnet_network="devnet",
            notes="pool address required from Gateway pool list",
        ),
        DexSpec(
            "meteora",
            "meteora",
        ...
        DexSpec(
            ...
            None,
            500_000,
            notes="Universal Router via Permit2; approvals needed once per token",
        ),
        DexSpec(
            "uniswap-base",
            "uniswap",
        ...
        DexSpec(
            "uniswap-bsc", "uniswap", "router", Chain.BSC, "ethereum", "bsc", "Uniswap (BSC)", None, 500_000
        ),
        DexSpec(
            "uniswap-avalanche",
            "uniswap",
        ...
        DexSpec(
            ...
            None,
            300_000,
            notes="requires 0x API key in Gateway",
        ),
        DexSpec(
            "0x-base",
            "0x",
