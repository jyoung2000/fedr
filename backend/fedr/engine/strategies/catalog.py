...
CATALOG: dict[Strategy, StrategyInfo] = {
    ...
    Strategy.SPOT_PERP: StrategyInfo(Strategy.SPOT_PERP, "Spot ↔ Perpetual", "Long spot / short perpetual (or reverse) when the perp trades away from spot.", False, (VenueKind.CEX, VenueKind.PERP), carry=True, risks=["funding reversal", "liquidation", "basis widening"]),
    Strategy.FUNDING: StrategyInfo(Strategy.FUNDING, "Funding-rate", "Delta-neutral spot + perp to collect funding payments.", False, (VenueKind.CEX, VenueKind.PERP), carry=True, risks=["funding reversal", "liquidation"]),
    Strategy.BASIS: StrategyInfo(Strategy.BASIS, "Cash-and-carry / basis", "Capture the spread between spot and a derivative until convergence.", False, (VenueKind.CEX, VenueKind.PERP), carry=True, risks=["basis widening", "margin"]),
